                            ...
                            <tbody>
                                {topic.problems.map((problem, index) => (
                                    <tr key={index}>
                                        ...
                                        <td ><Link to="youtube.com" href={problem.article} className="flex justify-center"> <RiArticleLine className="text-2xl text-blue-600" /> </Link></td>
                                        <td ><Link to="youtube.com" href={problem.video} className="flex justify-center"><FaYoutube className="text-2xl text-red-600 " /></Link></td>
                                        <td >
                                            {/* {problem.difficulty} */}
                                            <Link to="youtube.com" className="flex justify-center"><SiLeetcode className="text-2xl text-yellow-500" /></Link>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
